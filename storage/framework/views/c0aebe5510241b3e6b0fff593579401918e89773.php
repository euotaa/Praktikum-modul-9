                ...
                <ul class="navbar-nav ms-auto">
                    <?php if(auth()->guard()->guest()): ?>
                        <?php if(Route::has('login')): ?>
                            <li class="nav-item">
                                <a class="btn btn-outline-light my-2 ms-md-auto" href="<?php echo e(route('login')); ?>"><i
                                        class="bi-person-circle me-1"></i><?php echo e(__('Login')); ?></a>
                            </li>
                        <?php endif; ?>
                    <?php else: ?>
...
<?php /**PATH C:\Users\HP\Documents\1- Kuliah\4 - Semester 4\Pemrograman Framework\Modul8 lanjutan\resources\views/layouts/nav.blade.php ENDPATH**/ ?>